function VideoEllipseBrush(canvases, video) {
    // const video = new Video();
    const shaderCloud = new ShaderEllipse();


    
    const canvas2 = canvases.add('VideoEllipseBrush-canvas2');
    const canvas2Ctx = canvas2.getContext('2d');
    const canvas1 = canvases.add('VideoEllipseBrush-canvas1');
    const canvas1Ctx = canvas1.getContext('2d');

    const canvas3 = canvases.add('VideoEllipseBrush-canvas3');
